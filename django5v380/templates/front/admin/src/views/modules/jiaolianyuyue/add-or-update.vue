<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="预约编号" prop="yuyuebianhao">
					<el-input v-model="ruleForm.yuyuebianhao" placeholder="预约编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yuyuebianhao" label="预约编号" prop="yuyuebianhao">
					<el-input v-model="ruleForm.yuyuebianhao" placeholder="预约编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="私教价格" prop="sijiaojiage">
					<el-input v-model="ruleForm.sijiaojiage" placeholder="私教价格" clearable  :readonly="ro.sijiaojiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="私教价格" prop="sijiaojiage">
					<el-input v-model="ruleForm.sijiaojiage" placeholder="私教价格" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="健身卡编号" prop="jianshenkabianhao">
					<el-select :disabled="ro.jianshenkabianhao" @change="jianshenkabianhaoChange" v-model="ruleForm.jianshenkabianhao" placeholder="请选择健身卡编号">
						<el-option
							v-for="(item,index) in jianshenkabianhaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="余额" prop="yue">
					<el-input v-model="yue" placeholder="余额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yue" label="余额" prop="yue">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				jianshenkabianhao: [
					{ required: true, message: '健身卡编号不能为空', trigger: 'blur' },
				],
				jianshenkamingcheng: [
				],
				jine: [
	...
	computed: {
		yue: {
			get: function () {
				return 0-parseFloat(this.ruleForm.sijiaojiage==""?0:this.ruleForm.sijiaojiage)+parseFloat(this.ruleForm.jine==""?0:this.ruleForm.jine) || 0
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='sijiaojiage'){
							this.ruleForm.sijiaojiage = obj[o];
							this.ro.sijiaojiage = true;
							continue;
						}
						if(o=='yuyueshijian'){
            ...
            this.$http({
				url: `option/jianshenka/jianshenkabianhao`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.jianshenkabianhaoOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
			...
			// 下二随
			jianshenkabianhaoChange () {
				this.$http({
					url: `follow/jianshenka/jianshenkabianhao?columnValue=`+ this.ruleForm.jianshenkabianhao,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
						if(data.data.jianshenkamingcheng){
							this.ruleForm.jianshenkamingcheng = data.data.jianshenkamingcheng
						}
						if(data.data.jine){
    ...
    onSubmit() {
      ...
      if(parseFloat(this.ruleForm.sijiaojiage)>parseFloat(this.ruleForm.jine)){
        this.$message.error("私教价格不能超过金额");
        return
      }
