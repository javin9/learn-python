<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="借用编号" prop="jieyongbianhao">
					<el-input v-model="ruleForm.jieyongbianhao" placeholder="借用编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jieyongbianhao" label="借用编号" prop="jieyongbianhao">
					<el-input v-model="ruleForm.jieyongbianhao" placeholder="借用编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="借用时间" prop="jieyongshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jieyongshijian" label="借用时间" prop="jieyongshijian">
