<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="器材名称" prop="qicaimingcheng">
					<el-input v-model="ruleForm.qicaimingcheng" placeholder="器材名称" clearable  :readonly="ro.qicaimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="器材名称" prop="qicaimingcheng">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="使用方法" prop="shiyongfangfa">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shiyongfangfa" label="使用方法" prop="shiyongfangfa">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shiyongfangfa}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="瘦身效果" prop="shoushenxiaoguo">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shoushenxiaoguo" label="瘦身效果" prop="shoushenxiaoguo">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shoushenxiaoguo}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="器材介绍" prop="qicaijieshao">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qicaijieshao" label="器材介绍" prop="qicaijieshao">
...
export default {
	...
	this.ruleForm.qicaijieshao = this.ruleForm.qicaijieshao.replace(reg,'../../../django5v380/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
