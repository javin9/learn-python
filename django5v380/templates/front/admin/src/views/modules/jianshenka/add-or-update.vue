<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="健身卡编号" prop="jianshenkabianhao">
					<el-input v-model="ruleForm.jianshenkabianhao" placeholder="健身卡编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jianshenkabianhao" label="健身卡编号" prop="jianshenkabianhao">
					<el-input v-model="ruleForm.jianshenkabianhao" placeholder="健身卡编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="健身卡名称" prop="jianshenkamingcheng">
					<el-input v-model="ruleForm.jianshenkamingcheng" placeholder="健身卡名称" clearable  :readonly="ro.jianshenkamingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="健身卡名称" prop="jianshenkamingcheng">
					<el-input v-model="ruleForm.jianshenkamingcheng" placeholder="健身卡名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="金额" prop="jine">
					<el-input v-model="ruleForm.jine" placeholder="金额" clearable  :readonly="ro.jine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="金额" prop="jine">
					<el-input v-model="ruleForm.jine" placeholder="金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="开卡日期" prop="kaikariqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.kaikariqi" 
						type="date"
						:readonly="ro.kaikariqi"
						placeholder="开卡日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.kaikariqi" label="开卡日期" prop="kaikariqi">
					<el-input v-model="ruleForm.kaikariqi" placeholder="开卡日期" readonly></el-input>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				jianshenkabianhao : false,
				jianshenkamingcheng : false,
				jine : false,
				kaikariqi : false,
			...
			ruleForm: {
				jianshenkabianhao: this.getUUID(),
				jianshenkamingcheng: '',
				jine: '0',
				kaikariqi: '',
				yonghuzhanghao: '',
			...
			rules: {
				...
				jianshenkamingcheng: [
					{ required: true, message: '健身卡名称不能为空', trigger: 'blur' },
				],
				jine: [
	...
	created() {
		this.ruleForm.kaikariqi = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='jianshenkabianhao'){
							this.ruleForm.jianshenkabianhao = obj[o];
							this.ro.jianshenkabianhao = true;
							continue;
						}
						if(o=='jianshenkamingcheng'){
							this.ruleForm.jianshenkamingcheng = obj[o];
							this.ro.jianshenkamingcheng = true;
							continue;
						}
						if(o=='jine'){
						...
						if(o=='kaikariqi'){
							this.ruleForm.kaikariqi = obj[o];
							this.ro.kaikariqi = true;
							continue;
						}
						if(o=='yonghuzhanghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianshenka/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianshenkaCrossAddOrUpdateFlag = false;
						 this.parent.search();
