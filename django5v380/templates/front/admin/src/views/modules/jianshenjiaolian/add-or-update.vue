	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="价格/节课" prop="sijiaojiage">
					<el-input v-model="ruleForm.sijiaojiage" placeholder="价格/节课" clearable  :readonly="ro.sijiaojiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="价格/节课" prop="sijiaojiage">
					<el-input v-model="ruleForm.sijiaojiage" placeholder="价格/节课" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="个人简介" prop="gerenjianjie">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.gerenjianjie" label="个人简介" prop="gerenjianjie">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gerenjianjie"></span>
                </el-form-item>
...
export default {
	...
	this.ruleForm.gerenjianjie = this.ruleForm.gerenjianjie.replace(reg,'../../../django5v380/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
