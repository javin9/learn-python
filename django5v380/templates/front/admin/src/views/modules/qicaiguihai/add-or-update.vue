  ...
  <div class="addEdit-block" style="width: 100%">
    ...
    >
      <template>
        ...
        >
          <el-input
            v-model="ruleForm.jieyongbianhao"
            placeholder="借用编号"
            clearable
            :readonly="ro.jieyongbianhao"
          ></el-input>
        </el-form-item>
        <el-form-item
          :style="{ width: '50%', margin: '0 0 20px 0' }"
        ...
        >
          <el-input
            v-model="ruleForm.qicaimingcheng"
            placeholder="器材名称"
            clearable
            :readonly="ro.qicaimingcheng"
          ></el-input>
        </el-form-item>
        <el-form-item
          :style="{ width: '50%', margin: '0 0 20px 0' }"
        ...
        <el-form-item
          :style="{ width: '50%', margin: '0 0 20px 0' }"
          class="input"
          v-else-if="ruleForm.guihaishijian"
          label="归还时间"
          prop="guihaishijian"
        >
          <el-input
