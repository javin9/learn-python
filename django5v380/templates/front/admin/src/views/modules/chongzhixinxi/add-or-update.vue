		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="健身卡编号" prop="jianshenkabianhao">
					<el-input v-model="ruleForm.jianshenkabianhao" placeholder="健身卡编号" clearable  :readonly="ro.jianshenkabianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="健身卡编号" prop="jianshenkabianhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="充值时间" prop="chongzhishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chongzhishijian" label="充值时间" prop="chongzhishijian">
